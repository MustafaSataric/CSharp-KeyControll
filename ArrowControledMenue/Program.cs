...
int selectedClass = Menue("Arrow controlle menue", "B", "C", "D", "A", "B", "C", "D");

    static int Menue(string title, params string[] options)
    {
        Console.Title = "Key controlled menue V1.0 © Semir Sljiivic";
